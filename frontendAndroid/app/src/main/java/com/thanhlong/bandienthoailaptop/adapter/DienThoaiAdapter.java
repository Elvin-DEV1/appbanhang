package com.thanhlong.bandienthoailaptop.adapter;
...
import com.thanhlong.bandienthoailaptop.Interface.ItemClickListener;
import com.thanhlong.bandienthoailaptop.R;
import com.thanhlong.bandienthoailaptop.activity.ChiTietActivity;
...
public class DienThoaiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //nếu có data thì viewholder không có thì load viewholder
    ...
    public int getItemViewType(int position) {
        //nếu get 1 vị trí nào đó bằng null thì sẽ là loại loading còn không thì là loại data
