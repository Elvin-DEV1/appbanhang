...
import com.thanhlong.bandienthoailaptop.adapter.GioHangAdapter;
import com.thanhlong.bandienthoailaptop.model.EventBus.TinhTongEvent;
...
public class GioHangActivity extends AppCompatActivity {
    ...
    private void tinhTongTien() {
        ...
        for(int i=0;i<Utils.mangmuahang.size();i++){
            tongtiensp = tongtiensp + (Utils.mangmuahang.get(i).getSoluong() * Utils.mangmuahang.get(i).getGiasp());
        }
